...
class EngineersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create engineer" do
    assert_difference("Engineer.count") do
      post engineers_url, params: { engineer: { branch: @engineer.branch, joined100x: @engineer.joined100x, name: @engineer.name } }
    end
  ...
  test "should update engineer" do
    patch engineer_url(@engineer), params: { engineer: { branch: @engineer.branch, joined100x: @engineer.joined100x, name: @engineer.name } }
